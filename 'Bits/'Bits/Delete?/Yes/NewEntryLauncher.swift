...
//            dimmedView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(dismissView)))
//
//            window.addSubview(dimmedView)
//            window.addSubview(collectionView)
//
//            collectionView.frame = CGRect(x: 0, y: window.frame.height * (1/2), width: window.frame.width, height: window.frame.height * (1/2))
//
...
////
////            case .newEntry:
////                collectionView.frame = CGRect(x: 0, y: window.frame.height * (2/3), width: window.frame.width, height: window.frame.height * (2/3))

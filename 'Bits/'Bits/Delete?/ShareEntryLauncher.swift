...
//import UIKit
//
//class ShareEntryLauncher: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
//
...
//            dimmedView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(dismissShareEntryView)))
//
...
//    }
//
//    @objc func dismissShareEntryView() {
...
//
//        collectionView.register(ShareEntryCell.self, forCellWithReuseIdentifier: cellId)
//
//    }
//
//

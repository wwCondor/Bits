...
//
//
//class SortMenuLauncher: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
//    
//    let dimmedView = UIView() // This is the view that will be used to dim the background
//    
//    let sortCollectionView: UICollectionView = {
...
//            window.addSubview(sortCollectionView)
//            
////            let height = window.safeAreaLayoutGuide.topAnchor - window.safeAreaLayoutGuide.bottomAnchor
//            
//            sortCollectionView.translatesAutoresizingMaskIntoConstraints = false // enabels autoLayout for menuBar
//            sortCollectionView.heightAnchor.constraint(equalToConstant: window.bounds.height * (1/6)).isActive = true // Height of the menuBar
//            sortCollectionView.widthAnchor.constraint(equalToConstant: window.bounds.width).isActive = true
//
//            sortCollectionView.bottomAnchor.constraint(equalTo: window.bottomAnchor, constant: 0).isActive = true
//            
////            collectionView.frame = CGRect(x: 0, y: window.frame.height, width: window.frame.width, height: window.frame.height / 8)
//            sortCollectionView.center.x -= window.bounds.height // This view starts left outside the window.bounds and is animated in
//            
...
//                           animations: {
//                            self.sortCollectionView.center.x += window.bounds.height
...
//                        
//                        if let window = window {
//                            self.sortCollectionView.center.x -= window.bounds.width
//                        }
//                        
...
//        
//        sortCollectionView.register(SortOptionCell.self, forCellWithReuseIdentifier: cellId)
//        
//    }
//    
//}
